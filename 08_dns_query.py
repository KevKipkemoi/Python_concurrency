'''Sets up a dictionary that dumbly maps a few domains to
IPv4 addresses
Followed up by two functions that extract information from a
binary DNS query packet and constructs a response.

Run the file and run a query almost similar to the one below
